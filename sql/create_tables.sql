...
IF OBJECT_ID('bronze.raw_api_responses', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('silver.stg_fx_rates', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('gold.daily_volatility', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('gold.currency_performance', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('gold.anomaly_alerts', 'U') IS NULL
BEGIN
